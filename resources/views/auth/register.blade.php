@extends('layouts.frontend', ['title' => trans('adminlte.auth.register.title'), 'class' => 'homepage', 'header' => false])
            ...
            <div class="row">
                <div class="auth-form col-md-6 col-sm-12">
                    <div class="d-flex align-items-left justify-content-left mb-3 mb-lg-4">
                        <img class="img-h75 mb-0" src="{{ asset('images/logo.png') }}" alt="@lang('adminlte.auth.register.title')">
                    </div>
                    <h2 class="text-primary font-weight-600 mb-3">
                        @lang('adminlte.auth.register.title')
                    </h2>
                                    ...
                                    <small class="mt-3 d-block">
                                        @if(Route::has('login'))
                                            <a class="btn btn-link btn-sm" href="{{ route('login') }}">
                                                @lang('adminlte.auth.register.login')
                                            </a>
                                        @endif
                                    </small>
                                </div>
