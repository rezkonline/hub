<template>
    <div class="form-group">
        ...
        <select ref="select" class="form-control" :name="name" :id="name" v-model="selected" :multiple="multiple">
    ...
    export default {
        ...
        mounted() {
            if (this.value) {
                ...
                this.axios.get(this.remoteUrl, {selected_id: this.selected})
                    .then(response => {
            ...
            $(this.$refs.select).select2({
                ...
                ajax: {
                    ...
                    data: (params) => {
                        return {
                            selected_id: this.selected || this.selected,
