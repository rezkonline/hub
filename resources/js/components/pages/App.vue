    ...
    <div class="block__menusfixed position-relative">
        ...
        <div class="block__menusfixed--menus position-fixed bg-white shadow">
            ...
            <ul class="list">
                ...
                <li :class="$route.name === 'meeting' ? 'active' : ''" v-if="$store.state.user.impersonator === null || typeof $store.state.user.impersonator === 'undefined' || $store.state.user.impersonator.type !== 'employee'">
                    <router-link :to="{ name: 'meeting' }"><i class="fa fa-handshake d-md-block mb-md-2 mr-2 mr-md-0 font-16 font-lg-24"></i> {{ $t('frontend.menus.meeting') }}</router-link>
                </li>
