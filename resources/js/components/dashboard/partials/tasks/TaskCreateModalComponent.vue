<template>
    <modal name="create-task" height="auto" :scrollable="true" :adaptive="true" @before-close="beforeCloseCreateTaskModal">
                ...
                <form @submit.prevent="handleSubmit(createTask)">
                    <div class="row row-p8">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label class="d-block m-0">
                                    ...
                                    <validation-provider :name="$t('tasks.attributes.name')" rules="required" v-slot="{ errors, classes }">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label class="d-block m-0">
                                    ...
                                    <validation-provider :name="$t('tasks.attributes.description')" rules="required" v-slot="{ errors, classes }">
                            ...
                            <div class="form-group">
                                <label class="d-block m-0">
                                    <h3 class="font-16 mb-3 mt-0">
                                        ...
                                        {{ $t('tasks.attributes.attachments') }}
                                    </h3>
                        ...
                        <div class="col-lg-12 text-right">
                            <button class="btn btn-outline-primary btn-lg btn-mw-full btn-md-mw150 mr-md-1 rounded mb-2" type="button" @click="$modal.hide('create-task', {reset: true})">{{ $t('tasks.dialogs.delete.cancel') }}</button>
                            <button class="btn btn-primary btn-lg btn-mw-full btn-md-mw150 rounded mb-2" type="submit" :disabled="creating">{{ $t('tasks.actions.save') }}</button>
                        </div>
                    </div>
                </form>
            </validation-observer>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            beforeCloseCreateTaskModal(event) {
