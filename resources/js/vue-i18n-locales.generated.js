export default {
    "ar": {
        ...
        "admins": {
            ...
            "select": "اختر مدير",
            "select-type": "الكل",
            "perPage": "عدد المديرين في الصفحة",
            "actions": {
                "list": "عرض المديرين ",
                "show": "عرض",
            ...
            "messages": {
                "created": "تم إضافة مدير بنجاح .",
                "updated": "تم تعديل مدير بنجاح .",
                "deleted": "تم حذف مدير بنجاح ."
            },
            "attributes": {
                "name": "اسم مدير",
            ...
            "dialogs": {
                "delete": {
                    "title": "تحذير !",
                    "info": "هل أنت متأكد انك تريد حذف هذا مدير ?",
                    "confirm": "حذف",
                    "cancel": "إلغاء"
                }
            }
        ...
        "attachments": {
            ...
            "messages": {
                "created": "تم اضافة المرفقات بنجاح.",
                "deleted": "تم حذف المرفق بنجاح."
            },
            "dialogs": {
                "delete": {
                    "title": "تحذير !",
                    "info": "هل أنت متأكد انك تريد حذف هذا المرفق ?",
                    "confirm": "حذف",
                    "cancel": "إلغاء"
                }
            }
        ...
        "logs": {
            ...
            "select": "اختر سجل",
            "sentences": {
                "create": "قام {name} بأنشائها {time}",
                "update": "قام {name} بتغيير الحالة الي {status} {time}"
            },
            "perPage": "عدد السجلات بالصفحة",
            "actions": {
                "list": "عرض السجلات ",
                "filter": "بحث"
            }
        ...
        "notifications": {
            ...
            "tasks": {
                ...
                "status": {
                    "ongoing": "تم تغيير حالة المهمة {title} الي جارية",
                    "completed": "تم تغيير حالة المهمة {title} الي منتهية"
                }
            },
            "campaigns": {
                "body": "اضاف {user} حملة اعلانية جديدة بعنوان {title}",
                "status": {
                    "ongoing": "تم تغيير حالة الحملة الاعلانية {title} الي جارية",
                    "completed": "تم تغيير حالة الحملة الاعلانية {title} الي منتهية"
                }
            },
            "schedules": {
                "body": "اضاف {user} محتوي مجدول جديد بعنوان {title}",
                "status": {
                    "ongoing": "تم تغيير حالة المحتوي المجدول {title} الي جارية",
                    "completed": "تم تغيير حالة المحتوي المجدول {title} الي منتهية"
                }
            },
            "messages": {
        ...
        "package_features": {
            "plural": "مميزات الباقة",
            "singular": "ميزة الباقة",
            "actions": {
                "show": "مميزات {name}"
            }
        },
        ...
        "settings": {
            "plural": "الاعدادات",
            "actions": {
                "list": "قائمة الاعدادات",
                "save": "حفظ"
            },
            "attributes": {
                "title": "العنوان",
                "copyright": "الحقوق في الفوتر",
        ...
        "statistics": {
            ...
            "supervisors": "عدد مديري الحسابات",
            "employees": "عدد الموظفين",
            "tasks": "عدد المهمات",
            "schedules": "المحتوي المجدول",
            "campaigns": "الحملات الاعلانية",
            "total_payed": "المدفوعات",
            "total_remaining": "المستحقات",
            "actions": {
                "more": "مشاهدة المزيد"
            }
        },
    ...
    "en": {
        "achievements": {
            ...
            "empty": "There are no achievements",
            "perPage": "Count Achievements Per Page",
            "actions": {
            ...
            "messages": {
                "created": "The achievement has been created successfully.",
                "updated": "The achievement has been updated successfully.",
                "deleted": "The achievement has been deleted successfully."
            },
            "attributes": {
                "title": "Title",
                "value": "Value",
            ...
            "dialogs": {
                "delete": {
                    "title": "Warning !",
                    "info": "Are you sure you want to delete the achievement ?",
                    "confirm": "Delete",
                    "cancel": "Cancel"
                }
            }
        ...
        "cities": {
            ...
            "select": "Select City",
            "perPage": "Count Countries Per Page",
            "actions": {
                "list": "List Countries",
                "show": "Show City",
        ...
        "comments": {
            ...
            "messages": {
                "created": "The comment has been created successfully ."
            },
            "attributes": {
                "body": "Body"
            }
        ...
        "packages": {
            "plural": "Packages",
            "singular": "Package",
            "empty": "There are no packages",
            "perPage": "Count Packages Per Page",
            "actions": {
                "list": "List Packages",
                "show": "Show Packages",
